...
class Hospede(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE)  # Ligação com o usuário Django padrão
    nome_completo = models.CharField(max_length=255)  # Nome completo do hóspede
    email = models.EmailField()  # Email do hóspede
    telefone = models.CharField(max_length=20, blank=True, null=True)  # Telefone do hóspede (opcional)
